...
export default function Card({
  ...
  return (
    ...
    >
      <section className="max-w-screen-md border border-none rounded-md overflow-hidden sm:pr-8 relative h-full transition sm:group-even:pl-8 text-white bg-gradient-to-br from-blue/80 via-blue/70 to-red/40 hover:bg-red/20 duration-300 drop-shadow-md">
